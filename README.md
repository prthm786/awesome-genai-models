...
| ------- | ----------- | --------- | ------ | ----- | 
| Mixtral 8x22B (MoE) | [Mistral AI](https://mistral.ai/) | 176B Active 40B | Mixtral-8x22B Large Language Model (LLM) is a pretrained generative Sparse Mixture of Experts. It has contect length of 65,000 tokens. | [Hugging Face](https://huggingface.co/mistral-community/Mixtral-8x22B-v0.1) |
